...
class ItemsInDomain extends DatabaseViews{
    public function __construct()
    {
        ...
        $this->SqlView = "SELECT UserDomainsItems.GenerateHiddenInput, UserDomainsItems.ValueForAllLangues, UserDomainsItems.OnChangeEvent, UserDomainsItems.AddToSort, UserDomainsItems.Autocomplete,UserDomainsItemsInGroups.GroupId, UserDomainsItems.DomainSettings,UserDomainsItems.ShowOnlyDetail, UserDomainsItems.AddCDATA, UserDomainsItems.NoUpdate,UserDomainsItems.Domain, UserDomainsItems.CssClass,UserDomainsItems.ShowInAdminReadOnly,
