...
class FrontendDetailPreview extends DatabaseViews{
    public function __construct()
    {
        ...
        $this->SqlView = "SELECT DISTINCT ContentVersion.Date,Content.Sort, Content.SaveToCache, Content.NoLoadSubItems, Content.ActivatePager, Content.FirstItemLoadPager, Content.NextItemLoadPager,Content.TemplateId,Content.Id, ContentSecurity.GroupId, ContentVersion.WebId,ContentVersion.LangId,ContentVersion.Name, ContentVersion.SeoUrl,ContentVersion.AvailableOverSeoUrl,ContentVersion.Data,ContentVersion.Header,ContentVersion.ActiveFrom,Content.ContentType,  
